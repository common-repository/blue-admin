...
if(ba_get_option('blue_admin_login_page') =='1')
{
	...
	function ba_login_logo()	
	{
		...
		if(isset($ba_lp_options['fm_no_bg_color']) && $ba_lp_options['fm_no_bg_color']=='1'){
			...
			$bg_color=''.ba_add_hash($ba_lp_options['fm_bg_color'])	;
		}
			echo '
			<style type="text/css">
				.login form{
					background:'.$bg_color.'!important;
					color:'.ba_add_hash($ba_lp_options['fm_color']).'!important;
				...
				.login #nav a, 
				.login h1 a{
					color: '.ba_add_hash($ba_lp_options['text_color']).'!important;
				}
				.login #login_error, 
				.login .message,
				.login .message a,
	...
	function ba_login_bg()	
	{
		global $ba_lp_options;
			echo '
				...
				body,
				body.login{ ';
					if(isset($ba_lp_options['bg_color']) && ( $bg_color= ba_add_hash($ba_lp_options['bg_color']) )){
